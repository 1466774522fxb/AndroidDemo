...
import com.androiddemo.BuildConfig;
...
public final class Constant {
    ...
    public static final String API_CHANGE_REPASS = API_URL_PRE
            + "User/password";
    public static final String API_FAVORITE = API_URL_PRE
            + "User/favorite";
    ...
    public static final String API_USER_SETTING = API_URL_PRE
            + "User/setting";
    public static final String API_GET_DOCTOR_DETAIL = API_URL_PRE
            + "Doctor/detail";
    public static final String API_GET_DOCTOR_PRODUCT = API_URL_PRE
            + "Doctor/products";
    public static final String API_FAVORITE_LIST = API_URL_PRE
            + "User/favorite_list";
    public static final String API_GET_NEWS_DETAIL = API_URL_PRE
            + "News/detail";
    public static final String API_GET_NEWS_COMMENTS = API_URL_PRE
            + "News/comments";
    public static final String API_POST_NEWS_REPLY = API_URL_PRE
            + "News/reply";
    public static final String API_GET_USER_INFO = API_URL_PRE
            + "User/userInfo";
}
